...
#ifndef BYCORF_IO_IO_URING_BACKEND_H_
#define BYCORF_IO_IO_URING_BACKEND_H_
...
// here. The backend may touch Connection (bycorf-internal) and uses the Worker
...
#endif  // BYCORF_IO_IO_URING_BACKEND_H_
