...
#ifndef BYCORF_RUNTIME_CROSS_CORE_H_
#define BYCORF_RUNTIME_CROSS_CORE_H_
...
#ifndef BYCORF_ENABLE_SUBMIT_TASK_COUNT
#define BYCORF_ENABLE_SUBMIT_TASK_COUNT 0
#endif
#ifndef BYCORF_ENABLE_CROSS_CORE_LATENCY_TRACE
#define BYCORF_ENABLE_CROSS_CORE_LATENCY_TRACE 0
#endif
...
#if BYCORF_ENABLE_SUBMIT_TASK_COUNT
...
class SubmitTaskAwaiter : public RemoteWork {
 public:
  ...
  static_assert(IsTask<TaskType>::value,
                "SubmitTaskTo fn must return bycorf::Task<T>");
...
#endif  // BYCORF_RUNTIME_CROSS_CORE_H_
