...
#ifndef CELER_RUNTIME_FOREIGN_EXECUTOR_H_
#define CELER_RUNTIME_FOREIGN_EXECUTOR_H_
...
// from arbitrary threads, including threads not created by Celer. The Runtime
...
#endif  // CELER_RUNTIME_FOREIGN_EXECUTOR_H_
